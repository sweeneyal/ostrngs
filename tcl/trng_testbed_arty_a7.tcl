...
proc create_root_design { parentCell } {
  ...
  set i_resetn [ create_bd_port -dir I i_resetn ]
  ...
  set_property CONFIG.NUM_MI {2} $perif_interconnect
  ...
  if { [catch {set TrngController_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $TrngController_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [list \
    CONFIG.cClockFrequency_Hz {100000000} \
  ...
  connect_bd_intf_net -intf_net TrngController_0_m_axi [get_bd_intf_pins TrngController_0/m_axi] [get_bd_intf_pins perif_interconnect/S00_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets TrngController_0_m_axi] [get_bd_intf_pins TrngController_0/m_axi] [get_bd_intf_pins ila_1/SLOT_0_AXI]
  connect_bd_intf_net -intf_net TrngTestbed_0_m_axi_mem [get_bd_intf_pins TrngTestbed_0/m_axi_mem] [get_bd_intf_pins ram_interconnect/S00_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets TrngTestbed_0_m_axi_mem] [get_bd_intf_pins TrngTestbed_0/m_axi_mem] [get_bd_intf_pins ila_0/SLOT_0_AXI]
  connect_bd_intf_net -intf_net mig_7series_0_DDR3 [get_bd_intf_ports ddr3_sdram] [get_bd_intf_pins mig_7series_0/DDR3]
  connect_bd_intf_net -intf_net perif_interconnect_M00_AXI [get_bd_intf_pins perif_interconnect/M00_AXI] [get_bd_intf_pins TrngTestbed_0/s_axi_trng]
  connect_bd_intf_net -intf_net perif_interconnect_M01_AXI [get_bd_intf_pins perif_interconnect/M01_AXI] [get_bd_intf_pins ram_interconnect/S01_AXI]
  ...
  assign_bd_address -offset 0x00000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces TrngController_0/m_axi] [get_bd_addr_segs TrngTestbed_0/s_axi_trng/reg0] -force
  assign_bd_address -offset 0x80000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces TrngController_0/m_axi] [get_bd_addr_segs mig_7series_0/memmap/memaddr] -force

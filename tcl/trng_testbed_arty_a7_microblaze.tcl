...
proc create_root_design { parentCell } {
  ...
  set_property CONFIG.NUM_MI {4} $perif_interconnect
  ...
  set block_cell_name TrngTestbed_0
  if { [catch {set TrngTestbed_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $TrngTestbed_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property CONFIG.cFifoWidth {4} $TrngTestbed_0


  # Create interface connections
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins perif_interconnect/S00_AXI] [get_bd_intf_pins microblaze_0/M_AXI_DP]
  connect_bd_intf_net -intf_net TrngTestbed_0_m_axi_mem [get_bd_intf_pins TrngTestbed_0/m_axi_mem] [get_bd_intf_pins ram_interconnect/S02_AXI]
  connect_bd_intf_net -intf_net axi_uartlite_0_UART [get_bd_intf_ports usb_uart] [get_bd_intf_pins axi_uartlite_0/UART]
  connect_bd_intf_net -intf_net microblaze_0_M_AXI_IP [get_bd_intf_pins microblaze_0/M_AXI_IP] [get_bd_intf_pins ram_interconnect/S01_AXI]
  connect_bd_intf_net -intf_net microblaze_0_debug [get_bd_intf_pins mdm_1/MBDEBUG_0] [get_bd_intf_pins microblaze_0/DEBUG]
  connect_bd_intf_net -intf_net microblaze_0_dlmb_1 [get_bd_intf_pins microblaze_0/DLMB] [get_bd_intf_pins microblaze_0_local_memory/DLMB]
  connect_bd_intf_net -intf_net microblaze_0_ilmb_1 [get_bd_intf_pins microblaze_0/ILMB] [get_bd_intf_pins microblaze_0_local_memory/ILMB]
  connect_bd_intf_net -intf_net mig_7series_0_DDR3 [get_bd_intf_ports ddr3_sdram] [get_bd_intf_pins mig_7series_0/DDR3]
  connect_bd_intf_net -intf_net perif_interconnect_M00_AXI [get_bd_intf_pins perif_interconnect/M00_AXI] [get_bd_intf_pins axi_gpio_0/S_AXI]
  connect_bd_intf_net -intf_net perif_interconnect_M01_AXI [get_bd_intf_pins perif_interconnect/M01_AXI] [get_bd_intf_pins axi_uartlite_0/S_AXI]
  connect_bd_intf_net -intf_net perif_interconnect_M02_AXI [get_bd_intf_pins perif_interconnect/M02_AXI] [get_bd_intf_pins TrngTestbed_0/s_axi_trng]
  connect_bd_intf_net -intf_net perif_interconnect_M03_AXI [get_bd_intf_pins perif_interconnect/M03_AXI] [get_bd_intf_pins ram_interconnect/S00_AXI]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_0_100M/slowest_sync_clk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins perif_interconnect/M00_ACLK] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins perif_interconnect/M01_ACLK] [get_bd_pins perif_interconnect/ACLK] [get_bd_pins perif_interconnect/S00_ACLK] [get_bd_pins ram_interconnect/ACLK] [get_bd_pins ram_interconnect/S00_ACLK] [get_bd_pins ram_interconnect/S01_ACLK] [get_bd_pins perif_interconnect/M02_ACLK] [get_bd_pins ram_interconnect/S02_ACLK] [get_bd_pins perif_interconnect/M03_ACLK] [get_bd_pins TrngTestbed_0/i_clk]
  ...
  connect_bd_net -net rst_clk_wiz_0_100M_peripheral_aresetn [get_bd_pins rst_clk_wiz_0_100M/peripheral_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins perif_interconnect/M00_ARESETN] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins perif_interconnect/M01_ARESETN] [get_bd_pins perif_interconnect/ARESETN] [get_bd_pins perif_interconnect/S00_ARESETN] [get_bd_pins ram_interconnect/ARESETN] [get_bd_pins ram_interconnect/S00_ARESETN] [get_bd_pins ram_interconnect/S01_ARESETN] [get_bd_pins perif_interconnect/M02_ARESETN] [get_bd_pins ram_interconnect/S02_ARESETN] [get_bd_pins perif_interconnect/M03_ARESETN] [get_bd_pins TrngTestbed_0/i_resetn]
  connect_bd_net -net rst_mig_7series_0_81M_peripheral_aresetn [get_bd_pins rst_mig_7series_0_81M/peripheral_aresetn] [get_bd_pins ram_interconnect/M00_ARESETN] [get_bd_pins mig_7series_0/aresetn]
  ...
  assign_bd_address -offset 0x00010000 -range 0x00001000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs TrngTestbed_0/s_axi_trng/reg0] -force
  ...
  assign_bd_address -offset 0x80000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces TrngTestbed_0/m_axi_mem] [get_bd_addr_segs mig_7series_0/memmap/memaddr] -force
